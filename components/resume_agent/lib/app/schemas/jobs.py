...
class Job(CamelModel):
    ...
    规则（2026-08-17）：岗位名称必填；JD 原文可选但鼓励填写
    （JD 越完整，Factsheet 提炼越准，生成越贴合）。
    """

    title: str = Field(min_length=1, max_length=64, description="岗位名称（必填）")
    jd_text: Optional[str] = Field(default=None, max_length=20000, description="JD 原文（可选，鼓励填写）")
